<div dir="rtl">
    ...
    <p>بجاش شما یک خروج جدید ایجاد می کنید (با قفل جدید) و این اطلاعات تراکنش رو به شبکه بیت‌کوین ارسال می کنید و منتظر این می مونید که استخراج گرها (استخراج‌کننده ها) تراکنش شما رو به زنجیره‌بلوک منتقل کنند.</p>
