<div dir="rtl">
    ...
    <p>بدون‌اغراق می‌شه گفت یکی از بهترین و هوشمندانه‌ترین بخش‌های شبکه‌ی بیت‌کوین فرآیند سختی شبکه و کارکرد اونه.</p>
    <p></p>
    ...
    <p>با توجه به این که در هر دقیقه تنها یک بار قادر به در آوردن شماره‌ای بین ۱ تا ۱۰۰ هستید، دو دقیقه زمانتون رو باید بگیره.</p>
    <p>اما این خیلی آسونه. پس هدف رو به ۲۰ تغییر می‌دم، که یعنی حالا می‌تونید ۱/۵ دفعه قبل عدد برنده در بیارید، یعنی الان هر پنج دقیقه یک بار برنده می‌شید.</p>
    ...
    <br>
    <br>
    <img src="https://learnmeabitcoin.com/beginners/images/difficulty/png/01-range_target_difficulty.png">
    ...
    <p>به‌این دلیله که هش هر بلوک یک چیزی شبیه به این می‌شه:</p>
