<div dir="rtl">
    ...
    <p>اما چون این اعدا بسیار زیاد هست، کامپیوتر ها (و همینطور خود بیت‌کوین) علاقه به این دارن که از شکل کوتاه تری از این شماره ها استفاده کنند که اون حالت هگزادسیمال می باشد:</p>
