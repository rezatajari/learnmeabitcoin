<div dir="rtl">
    ...
    <ul>
        <li>
            <p><a href="#1">ساتوشی ناکاموتو کیست؟</a></p>
        </li>
        <li>
            <p><a href="#2">کنترل بیت‌کوین دست چه کسی است؟</a></p>
        </li>
        <li>
            <p><a href="#3">نوسان قیمت بیت‌کوین خیلی زیاد نیست؟</a></p>
        </li>
        <li>
            <p><a href="#4">پشتوانه ارزش بیت‌کوین چیست؟</a></p>
        </li>
        <li>
            <p><a href="#5">چطور می‌توان به بیت‌کوین اعتماد کرد؟</a></p>
        </li>
        <li>
            <p><a href="#6">پایداری شبکه بیت‌کوین چقدر مورد اطمینان است؟</a></p>
        </li>
        <li>
            <p><a href="#7">چرا صرافی‌های بیت‌کوین هَک می‌شوند؟</a></p>
        </li>
        <li>
            <p><a href="#8">آیا خلاف‌کاران برای مقاصد پول‌شویی از بیت‌کوین استفاده می‌کنند؟</a></p>
        </li>
        <li>
            <p><a href="#9">آیا بیت‌کوین طرح پانزی (هِرمی) است؟</a></p>
        </li>
        <li>
            <p><a href="#10">آیا بیت‌کوین یک حباب است؟</a></p>
        </li>
        <li>
            <p><a href="#11">تِتِر چیست و چگونه روی بیت‌کوین اثر می‌گذارد؟</a></p>
        </li>
        <li>
            <p><a href="#12">آیا دولت‌ها می‌توانند استفاده از بیت‌کوین را ممنوع یا شبکه آن را خاموش کنند؟</a></p>
        </li>
        <li>
            <p><a href="#13">آیا استفاده از بیت‌کوین قانونی است؟</a></p>
        </li>
        <li>
            <p><a href="#14">آیا استخراج بیت‌کوین هَدر دادن انرژی است و به محیط زیست آسیب می‌رساند؟</a></p>
        </li>
        <li>
            <p><a href="#15">ممکن است کسی بتواند شبکه بیت‌کوین را با استفاده از یک اَبَر کامپیوتر یا یک کامپیوتر کوانتومی هَک کند؟</a></p>
        </li>
        <li>
            <p><a href="#16">بیت‌کوین چطور می‌تواند غیرمتمرکز بماند؟</a></p>
        </li>
        <li>
            <p><a href="#17">آیا بیت‌کوین از حریم خصوصی حفاظت می‌کند؟</a></p>
        </li>
        <li>
            <p><a href="#18">بیت‌کوین چطور می‌تواند نیازهای ۷ میلیارد نفر را برطرف کند؟</a></p>
        </li>
        <li>
            <p><a href="#19">آیا نابرابری ثروت در بیت‌کوین وجود دارد؟</a></p>
        </li>
        <li>
            <p><a href="#20">اگر فقط ۲۱ میلیون بیت‌کوین وجود داشته باشد، چطور همه مردم جهان می‌توانند از آن استفاده کنند؟</a></p>
        </li>
        <li>
            <p><a href="#21">من استطاعت خرید بیت‌کوین را ندارم. قیمت آن خیلی بالاست!</a></p>
        </li>
        <li>
            <p><a href="#22">چگونه می‌توانم بیت‌کوین بدست بیاورم؟</a></p>
        </li>
        <li>
            <p><a href="#23">چگونه از یک کیف‌پول بیت‌کوین استفاده کنم؟</a></p>
        </li>
    </ul>
    <hr>
    <hr>
    ...
    <p>همان‌طور که در قسمت «‌<a href="#7">چرا صرافی‌های بیت‌کوین هَک می‌شوند؟</a>» شرح دادیم، اگر سرمایه‌گذاران بیت‌کوین‌هایشان را در صرافی‌هایی آنلاین نگهداری کنند در معرض خطر هَک شدن خواهند گرفت. برداشت و انتقال بیت‌کوین‌ها به کیف‌پول شخصی بعد از خرید، این ریسک را از بین می‌برد.</p>
    <p><a href="https://bitcoind.me/blobs/books/ketabe-koochake-bitcoin-farsi.pdf">منبع: کتاب کوچک بیت‌کوین. ترجمه شده توسط وبسایت منابع فارسی بیت‌کوین</a></p>
    <small>توجه داشته باشید این مقاله کپی از فصل "سوال و جواب درباره بیتکوین" از کتاب "کتاب کوچک بیتکوین" ترجمه شده توسط وبسایت <a href="https://bitcoind.me">منابع فارسی بیتکوین</a> می باشد. اما به جهت جلوگیری از گیج شدن خواننده، اشاره ها به سایر مطالب کتاب تصحیح شده اند.</small>
</div>
